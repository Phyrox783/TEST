...
public class UpsidedowntoxicwaterBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:upsidedowntoxicwater")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("strangerthin:upsidedowntoxicwater_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public UpsidedowntoxicwaterBlock(StrangerthinModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("strangerthin:blocks/upside_down_toxic_water_still"),
						new ResourceLocation("strangerthin:blocks/upside_down_water1"))
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("upsidedowntoxicwater");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("upsidedowntoxicwater_flowing");
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 0)) {
				}.setRegistryName("upsidedowntoxicwater"));
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC).rarity(Rarity.COMMON))
				.setRegistryName("upsidedowntoxicwater_bucket"));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("upsidedowntoxicwater_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("strangerthin:upsidedowntoxicwater_lakes"),
					configuredFeature);
		}
	}
