...
public class UpsidedownvineBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:upsidedownvine")
	public static final Block block = null;

	public UpsidedownvineBlock(StrangerthinModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 1f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("upsidedownvine");
		}
