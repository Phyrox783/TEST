...
public class DeadbushBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:deadbush")
	public static final Block block = null;

	public DeadbushBlock(StrangerthinModElements instance) {
		super(instance, 11);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("deadbush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("strangerthin:deadbush"), configuredFeature);
		}
	}
