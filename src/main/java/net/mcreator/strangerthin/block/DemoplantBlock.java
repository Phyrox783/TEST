...
public class DemoplantBlock extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:demoplant")
	public static final Block block = null;

	public DemoplantBlock(StrangerthinModElements instance) {
		super(instance, 14);
	}
