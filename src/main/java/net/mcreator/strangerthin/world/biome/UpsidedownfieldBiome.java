...
import net.mcreator.strangerthin.block.UpsidedownfieldlogBlock;
import net.mcreator.strangerthin.block.UpsidedowndirtBlock;
...
public class UpsidedownfieldBiome extends StrangerthinModElements.ModElement {
	public static Biome biome;

	public UpsidedownfieldBiome(StrangerthinModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6710887).setWaterColor(-3750188).setWaterFogColor(-3750188)
						.withSkyColor(-6710887).withFoliageColor(-13261999).withGrassColor(-13261999).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(UpsidedowndirtBlock.block.getDefaultState(),
								UpsidedownstoneBlock.block.getDefaultState(), UpsidedownstoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(UpsidedownfieldlogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("strangerthin:upsidedownfield"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("upsidedownfield_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("upsidedownfield_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("upsidedownfield_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
