...
import net.mcreator.strangerthin.entity.renderer.MindlflayermeatRenderer;
import net.mcreator.strangerthin.StrangerthinModElements;

@StrangerthinModElements.ModElement.Tag
public class MindlflayermeatEntity extends StrangerthinModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(5f, 5f))
			.build("mindlflayermeat").setRegistryName("mindlflayermeat");

	public MindlflayermeatEntity(StrangerthinModElements instance) {
		super(instance, 35);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MindlflayermeatRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434880, -13230816, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("mindlflayermeat_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 80);
