...
import net.mcreator.strangerthin.entity.renderer.DemobatRenderer;
...
public class DemobatEntity extends StrangerthinModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(80).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
			.build("demobat").setRegistryName("demobat");

	public DemobatEntity(StrangerthinModElements instance) {
		super(instance, 29);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DemobatRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -3342337, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("demobat_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 100, 15, 20));
	}
