...
import net.mcreator.strangerthin.entity.renderer.SlingshotRenderer;
import net.mcreator.strangerthin.StrangerthinModElements;

import java.util.Random;

@StrangerthinModElements.ModElement.Tag
public class SlingshotItem extends StrangerthinModElements.ModElement {
	@ObjectHolder("strangerthin:slingshot")
	...
	public SlingshotItem(StrangerthinModElements instance) {
		super(instance, 37);
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == Blocks.STONE_BUTTON.asItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == Blocks.STONE_BUTTON.asItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(Blocks.STONE_BUTTON).isDamageable()) {
